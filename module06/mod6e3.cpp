...
int main (int argc, char *argv[] ){
  ...
  for (int i=0;i<height;i++){
	   ...
	   t=blue[i][width-j-1]; blue[i][width-j-1]=blue[i][j]; blue[i][j]=t;
	   t=green[i][width-j-1]; green[i][width-j-1]=green[i][j]; green[i][j]=t;
	   t=red[i][width-j-1]; red[i][width-j-1]=red[i][j]; red[i][j]=t;
       }
   }
  /*
   *  DO NOT go further
